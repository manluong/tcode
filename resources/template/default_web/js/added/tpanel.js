...
function dgroup_list(json){
	...
	if (json['list']['listnotitle'] == 1){
		...
		document.getElementById(json['element_id']).innerHTML = buttontop+'<table cellpadding="0" cellspacing="0" border="0" class="full divcard_inner tpaneltable_notitle" id="'+tableid+'"></table>'+buttonbottom;
		...
		document.getElementById(json['element_id']).innerHTML = buttontop+'<table cellpadding="0" cellspacing="0" border="0" class="full divcard_inner tpaneltable" id="'+tableid+'"></table>'+buttonbottom;
