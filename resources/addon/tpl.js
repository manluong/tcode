...
tpl_form.password = '<input type="password" class="{{addclass}}" id="form_{{name}}" value="{{value}}">';

tpl_form.date = '<input type="date" class="{{addclass}}" id="form_{{name}}" value="{{value}}">';
tpl_form.datetime = '<input type="date" class="{{addclass}}" id="form_{{name}}" value="{{value}}">';
tpl_form['time'] = '<input type="time" class="{{addclass}}" id="form_{{name}}" value="{{value}}">';
