...
tpl_form.checkbox = '<input type="checkbox" id="form_{{name}}" value="{{value}}">';
tpl_form.textarea = '<textarea class="{{addclass}}" id="form_{{name}}" rows="3">{{value}}</textarea>';

tpl_form.phone = '<input type="number" class="{{addclass}}" id="form_{{name}}" value="{{value}}">';

tpl_form.date = '<input type="date" class="{{addclass}} form-dateinput" id="form_{{name}}" value="{{value}}">';
tpl_form.datetime = '<input type="date" class="{{addclass}} form-dateinput" id="form_{{name}}" value="{{value}}">';
tpl_form['time'] = '<input type="time" class="{{addclass}} form-dateinput" id="form_{{name}}" value="{{value}}">';

tpl_form.select = '<select id="select01">{{#select_options}}<option value="{{value}}"{{selected}}>{{value}}</option>{{/select_options}}</select>';              
tpl_form.select_switch = '';

tpl_form.password = '<input type="password" class="{{addclass}}" id="form_{{name}}" value="{{value}}" autocomplete="off">';
tpl_form.file = '<input class="input-file" id="form_{{name}}" type="file">';
tpl_form.hidden = '<input type="hidden" id="form_{{name}}" value="{{value}}">';
