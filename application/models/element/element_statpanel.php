...
class Element_statpanel extends CI_Model {
	...
	$sql1 = "SELECT * FROM global_setting.core_e_statpanel WHERE core_e_statpanel_gp = '$this_element_name' ORDER BY core_e_statpanel_sort";
	...
	if ($result1){
	    ...
	    foreach ($result1 as $field1) {
	        ...
	        */
	        ...
	        $sql2 = "SELECT * FROM global_setting.core_e_statpanel_item WHERE core_e_statpanel_item_set = '".$field1['core_e_statpanel_set']."' AND core_e_statpanel_item_gp = '$this_element_name' ORDER BY core_e_statpanel_item_sort";
